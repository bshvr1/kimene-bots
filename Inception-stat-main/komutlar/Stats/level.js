...
module.exports.run = async (client, message, args, durum, kanal) => {
    if (!message.guild) return;
        ...
        let loading = await message.channel.send(`Veriler yükleniyor...`)
                ...
                const background = await loadImage("https://cdn.discordapp.com/attachments/833784440173232238/836787367196753940/kimenerank.png")
                ...
                const attachment = new MessageAttachment(image.toBuffer(), 'kimene-level.png');
                let embed = new MessageEmbed().setColor("0b7888").attachFiles(attachment).setImage('attachment://kimene-level.png')
